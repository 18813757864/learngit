!function() {
    ...
    }(), b = encodeURIComponent, c = "1277627309", d = "", e = "", f = "online_v3.php", g = "z9.cnzz.com", h = "1", i = "text", j = "z", k = "&#31449;&#38271;&#32479;&#35745;", l = window["_CNZZDbridge_" + c]["bobject"], m = "1", n = a + "//online.cnzz.com/online/" + f, o = [];
    o.push("id=" + c),
    o.push("h=" + g),
    o.push("on=" + b(e)),
    o.push("s=" + b(d)),
    ...
    var p, q, r, a = function() {
        ...
        c = a.length; c > b; b++)
            ...
            e.src && (d = /^(https?:)\/\/[\w\.\-]+\.cnzz\.com\//i.exec(e.src)))
                return d[1];
        return window.location.protocol
    }(), b = encodeURIComponent, c = "1277354711", d = "", e = "", f = "online_v3.php", g = "z5.cnzz.com", h = "1", i = "text", j = "z", k = "&#31449;&#38271;&#32479;&#35745;", l = window["_CNZZDbridge_" + c]["bobject"], m = "1", n = a + "//online.cnzz.com/online/" + f, o = [];
    o.push("id=" + c),
    o.push("h=" + g),
    o.push("on=" + b(e)),
    o.push("s=" + b(d)),
    ...
    p.prototype = {
                    ...
                    case "_trackPageview":
                        if (a[1]) {
                            ...
                            if ("" === a[2])
                                ...
                                var b = a[2];
                                "http" !== b.substr(0, 4) && (b = q + "//" + e.location.host,
                                "/" !== a[2].charAt(0) && (b += "/"),
                                b += a[2]);
                                this.a.g = b
                            }
        ...
        va: function() {
            try {
                ...
                0 < this.T() && 432E5 < (new Date).getTime() - this.T() && (this.a.C++,
                this.a.ea = (new Date).getTime()),
                this.a.C
            } catch (a) {
                h(a, "gRVT failed")
            }
        ...
        Z: function() {
            try {
                ...
                if (1E8 < this.c) {
                    ...
                    b.push(this.D);
                    0 < b.length ? (a += g(b.join("|")),
                    a += "; expires=" + c.toUTCString(),
                    a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString()
                } else
                    "none" !== this.a.l ? b.push("cnzz_eid=" + g(this.a.l)) : (d = Math.floor(2147483648 * Math.random()) + "-" + this.D + "-" + this.M(this.o()),
                    b.push("cnzz_eid=" + g(d))),
                    b.push("ntime=" + this.D),
                    0 < b.length ? (a += g(b.join("&")),
                    a += "; expires=" + c.toUTCString(),
        ...
        pa: function(a, b) {
            try {
                ...
                if (c) {
                    ...
                    "0" === this.A && l.write(x("%3Cscript src='" + a + "' charset='" + b + "' type='text/javascript'%3E%3C/script%3E"))
            } catch (f) {
                h(f, "cSI failed")
            }
        },
        ...
        j: function(a) {
            try {
                for (var b = a.length, c = null, d = 0; d < b; d++)
                    a[d] && (c = "cnzz_image_" + Math.floor(2147483648 * Math.random()),
                    e[c] = new Image,
                    e[c].ka = c,
                    e[c].onload = e[c].onerror = e[c].onabort = function() {
                        try {
...
___baidu_union_callback_("auto","d7cf399959ebe5f5a02e7c8fff669d79",[])