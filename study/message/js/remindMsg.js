    ...
    var tabControl = [
        // 全部
        {
            ...
            cols: [
                ...
                {label:'日期', name:'documentNumber',width:'25%', sortable:false,},
                {label:'早餐', name:'title', width:'25%', sortable:false},
                {label:'中餐', name:'createType',width:'25%',formatter: creTypeSendFmt, sortable:false},
                {label:'晚餐', name:'modifyDate', width:'25%',formatter: dateFmt, sortable:false},
